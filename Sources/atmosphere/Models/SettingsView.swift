    ...
    var body: some View {
        Form {
            Section(header: Text("Default Journal")) {
                Picker("Default Journal", selection: Binding(
                ...
                Text("When set to Automatic, new entries created outside a specific journal will go to Personal if available, otherwise the first journal.")
                    .font(.caption)
